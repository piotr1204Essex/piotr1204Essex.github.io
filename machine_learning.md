...
Convolutional Neural Network technology raises questions just like any other AI technology. Be it about data security and privacy, or transparency on how the data of a user landed in model's "hands"? I think the greatest question of all, when it comes to CNN is the facial recognition algorithms and their application in real-world. I cannot help but think of Orwell's 1984's (1949) vision of the future world, when I contemplate on applications of CNN and how easily they might be abused by those in a position of power. Facial recognition can be a brilliant tool in finding criminals by using eg. city cameras. Just to think about it seems like we are already living in an utopian (for all law-abiding citizens) era with close to 0% crime rates, right? If we can find anyone in no time, then there is really no point in committing a crime. On the other hand - we have seen Canadian government freezing accounts of protesters (Loh, 2022) who were legally protesting in a democratic country - their "crime" being not agreeing with the government*. What if the government starts to use such CNN based tools in order to refuse citizens their democratic rights? We might be on a verge of Orwell's prophecy. Therefore correct security policies and mechanisms must be in place in order to prevent abuse of such systems. If we, as humanity do it right - then the advantages of CNN systems will have an ever increasing number of positive social implications. One of my favourite is the CNN working together with Augmented Reality platforms, used by some companies (eg. company Ergonome in Poland). These companies usually sell some part of interior design. The Augmented Reality together with CNN allows users to scan their room and see how an item they're considering buying would fit in their room.

*I am no legal specialist and all of my knowledge about this situation is based on what the media published - which is why I take it as a possibility that the information is not fully correct. It is however to the best of my knowledge that I am analysing information provided and its interpretation should be regarded as such.
